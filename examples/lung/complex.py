...
plt.xlabel("MDI1")
plt.ylabel("MDI2")
plt.savefig(f"{os.getcwd()}/transmorph/examples/lung/figures/complex_pertype.png")
plt.show()
...
plt.xlabel("MDI1")
plt.ylabel("MDI2")
plt.savefig(f"{os.getcwd()}/transmorph/examples/lung/figures/complex_perpatient.png")
plt.show()
